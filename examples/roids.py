...
def main():
    ...
    class Poly():
        ...
        def draw(self, color):
            ...
            Draw the polygon
            '''
            tft.polygon(self.polygon, self.x, self.y, color, 255, self.angle, 0, 0)
    ...
    def explode_ship():
        ...
        ship.counter += 1
        if ship.counter % 2 == 0:
            tft.polygon(explosion_poly, ship.x, ship.y, st7789.BLACK, 255,  0.785398)
            tft.polygon(explosion_poly, ship.x, ship.y, st7789.WHITE)
        else:
            tft.polygon(explosion_poly, ship.x, ship.y, st7789.WHITE, 255, 0.785398)
