        ...
        while True:
            ...
            if background_change:
                ...
                digit_background = [
                    tft.jpg_decode(
                        ...
                        font.MAX_WIDTH if (digit != 2) else font.MAX_WIDTH//2,  # width of bitmap to save
            ...
            for digit in range(5):
                ...
                if time[digit] != last_time[digit]:
                    ...
                    if digit == 4 and last_time[digit] != '-' and BCKGROUND_LOCK == 0:
                        background_change = True
                    ...
                    tft.write(
                        ...
                        st7789.TRANSPARENT)         # transparent background
